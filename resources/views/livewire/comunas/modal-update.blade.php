<div class="fixed w-full inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster" style="background: rgba(0,0,0,.7);">
    <div class="border border-blue-500 shadow-lg mx-auto modal-container bg-white w-2/3 h-2/3 rounded-xl z-50 overflow-y-scroll">
        <div class="modal-content py-4 text-left px-6">
            <!--Title-->
            <div class="flex justify-between items-center pb-3">
                <p class="text-2xl font-bold text-gray-500">Modificar Consejo Comunal</p>
            </div>
            <!--Body-->
                ...
                <form class="w-full">
                    ...
                    <div class="flex justify-between pt-2 space-x-14">
                        ...
                        <button class="bg-yellow-500 hover:bg-yellow-600 px-4 py-2 rounded text-white focus:outline-none" 
                            wire:click.prevent="actualizar({{$id_comuna}})">Modificar</button>
                    </div>
                </form>
            </div>
        </div>
