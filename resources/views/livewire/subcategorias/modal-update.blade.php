    ...
    <div class="border border-blue-500 shadow-lg mx-auto modal-container bg-white w-2/3 rounded-xl z-50 overflow-y-auto">
        <div class="modal-content py-4 text-left px-6">
            ...
            <div class="flex justify-between items-center pb-3">
                <p class="text-2xl font-bold text-gray-500">Modificar Subcategoría</p>
            </div>
            <!--Body-->
            <div class="my-5 mr-5 ml-5 flex justify-center">
                <form class="w-full">
                    ...
                    <div class="">
                        <div class="">
                            <label for="nombre" class="text-md text-gray-600">Categoría</label>
                        </div>
                        <div class="">
                            <select class="block appearance-none w-full bg-grey-200 border border-grey-200 text-grey-darker py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-grey"
                                id="id_categoria" name="id_categoria" wire:model="id_categoria">
                    ...
                    <div class="flex justify-between pt-2 space-x-14">
                        ...
                        <button class="bg-yellow-500 hover:bg-yellow-600 px-4 py-2 rounded text-white focus:outline-none" 
                            wire:click.prevent="actualizar({{$id_subcat}})">Modificar</button>
                    </div>
                </form>
            </div>
        </div>
